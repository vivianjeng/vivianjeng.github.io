...
description: Use a RNN model to determine whether a post is positive or negative
summary: Use a RNN model to determine whether a post is positive or negative
...
## Compare the scores between bag of words (BOW) and a RNN model
...
- BOW only cares about the present of the given vocabularies but not the order
